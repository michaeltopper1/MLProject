...
\noindent Using a large dataset from the IPUMS CPS, we propose to answer the following questions:
  ...
  1) *Can we predict who gets a divorce based on characteristics from a sample?* Since [@becker1974theory], 
  ...
  3) *Does having young children impact divorce decisions?*
