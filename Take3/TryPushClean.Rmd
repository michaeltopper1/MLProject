...
author: "Michael Topper (#5788708) and Danny Klinenberg"
output: 
  pdf_document:
    fig_caption: TRUE
    fig_width: 6
...
To begin, we first made a classifier for whether a game had an average user score of a 7 or over on a 1-10 scale. This decision was made because 7 was approximately the 80th percentile of the distribution of scores (see Figure \ref{dist}).  After defining these classifiers, we performed logistic regression, k-nearest neighbors, and decision trees as our non-ensemble methods. For ensemble methods, we used random forests and bagging. More detailed explanations on how these were performed follow.
